...
void ureactor_on_timer(UReactor *d, int timeout, void *context, Demux_callback callback);
void ureactor_on_read_ready( UReactor *d, int fd, int timeout, void *context, Demux_callback callback);
void ureactor_on_write_ready(UReactor *d, int fd, int timeout, void *context, Demux_callback callback);
